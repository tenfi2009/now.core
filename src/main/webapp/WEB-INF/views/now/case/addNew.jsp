...
<form id="addNew_form" role="form" class="form-horizontal page-content" action="${ctx}/module/case/save" method="post">
	...
	<div class="form-group col-md-6">
		...
		<div class="col-md-8">
			<cm:dict name="sex" category="sex" id="sex" displaySelectAll="true" myClass="input-xlarge form-control" expression="required"></cm:dict>
		</div>
	</div>
	<div class="form-group col-md-6" >
	...
	<div class="form-group col-md-6">
		...
		<div class="col-md-8">
			<input type="text" class="form-control" class="input-xlarge" id="mobileNumber" name="mobileNumber" maxlength="11" required/> 
		</div>
	</div>
...
<script type="text/javascript">
	$(function() {
		...
		validate("#addNew_form", rules, messages);
