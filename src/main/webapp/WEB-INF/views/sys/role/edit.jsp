...
<form id="edit_form" class="form-horizontal" action="sys/role/save" method="post">
	<input type="hidden" name="id" value="${role.id}"/>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="code"><span style="color: red">*</span>角色编码：</label>
		<div class="col-sm-9">
			<input type="text" id="code" name="code" value="${role.code}" maxlength="32" required class="input-xlarge" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="name" name="name" value="${role.name}" maxlength="64" required class="input-xlarge" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="sortNo">排序号：</label>
		<div class="col-sm-9">
			<input type="text" id="sortNo" name="sortNo" value="${role.sortNo}" digits="true" class="col-xs-10 col-sm-5" />
		</div>
	</div>
	<div>
